...
- <h4>Аутентификация - Next Auth.</h4>

- <h4>Библиотека UI - Shadcn.</h4>

- <h4>Иконки - Lucide-react.</h4>

- <h4>Хэширование данных - Bcryptjs.</h4>

<hr/>

<h1>Функционал:</h1>

- <h4>🔐 Аутентификация — регистрация и вход в систему.</h4>

- <h4>🛠️ Конструктор сборок — создание ПК из доступных компонентов.</h4>

- <h4>🌍 Публичные сборки — возможность делиться своими конфигурациями.</h4>

- <h4>❤️ Лайк чужих сборок.</h4>

- <h4>🏆 Популярные сборки.</h4>

- <h4>✏️ Редактирование сборки.</h4>
